  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="rounded-[2rem] bg-white/5 p-6 shadow-panel flex-1">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/10">
                ...
                <th className="px-4 py-3 text-left text-sm font-semibold text-brand-300">Actions</th>
              </tr>
            </thead>
            <tbody>
              {users.map((user) => (
                <tr key={user._id} className="border-b border-white/5 hover:bg-white/5">
                  ...
                  <td className="px-4 py-3 text-sm">
                    <button type="button" className="text-brand-300 hover:text-white transition">Edit</button>
                    <span className="mx-2 text-white/20">•</span>
                    <button type="button" className="text-red-400 hover:text-red-300 transition">Remove</button>
                  </td>
                </tr>
              ))}
            </tbody>
